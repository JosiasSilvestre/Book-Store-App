    ...
    function renderBookInfoSection() {
        return (
            <View style={{ flex: 1 }}>
                ...
                {/* Navigation header */}
                <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 70, alignItems: 'flex-end' }}>
                    <TouchableOpacity
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'row', padding: SIZES.padding }}>
                ...
                >
                    ...
                    <Text style={{ ...FONTS.description, color: COLORS.lightGray }}>{book.description}</Text>
                </ScrollView>
            </View>
        )
    }
